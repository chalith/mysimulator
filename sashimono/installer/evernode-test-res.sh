...
# Exucute the setup
curl -fsSL $setup | cat | sudo NETWORK=${NETWORK:-mainnet} OVERRIDE_EVERNODE_GOVERNOR_ADDRESS=rwDEhKkChUFpZ9Tmtq7e41LMFuvFwirHmf SKIP_SYSREQ=1 NO_DOMAIN=1 bash -s ${@}
