...
response=$(curl -s -w "%{http_code}" "https://raw.githubusercontent.com/$repo_owner/$repo_name/patch-v0.11.1/sashimono/patches/resources/sashimono/$file" -o "$SASHIMONO_BIN/$file")
